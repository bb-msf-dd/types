...
_STREAM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='guncad', full_name='pb.Stream.guncad', index=10,
...
_GUNCAD = _descriptor.Descriptor(
  name='Guncad',
  full_name='pb.Guncad',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='guncad_category', full_name='pb.Guncad.guncad_category', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='firearm_type', full_name='pb.Guncad.firearm_type', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='firearm_platform', full_name='pb.Guncad.firearm_platform', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='firearm_part', full_name='pb.Guncad.firearm_part', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='firearm_caliber', full_name='pb.Guncad.firearm_caliber', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fabrication_method', full_name='pb.Guncad.fabrication_method', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fabrication_tools', full_name='pb.Guncad.fabrication_tools', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='original_claim_id', full_name='pb.Guncad.original_claim_id', index=7,
      number=11, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_STREAM.fields_by_name['guncad'].message_type = _GUNCAD
...
_STREAM.oneofs_by_name['type'].fields.append(
  _STREAM.fields_by_name['guncad'])
_STREAM.fields_by_name['guncad'].containing_oneof = _STREAM.oneofs_by_name['type']
...
DESCRIPTOR.message_types_by_name['Guncad'] = _GUNCAD
...
Guncad = _reflection.GeneratedProtocolMessageType('Guncad', (_message.Message,), dict(
  DESCRIPTOR = _GUNCAD,
  __module__ = 'claim_pb2'
  # @@protoc_insertion_point(class_scope:pb.Guncad)
  ))
_sym_db.RegisterMessage(Guncad)
