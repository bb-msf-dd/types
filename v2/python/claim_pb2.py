...
_CLAIM = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='downloadable_file', full_name='pb.Claim.downloadable_file', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='guncad_file', full_name='pb.Claim.guncad_file', index=11,
...
_CLAIM.fields_by_name['downloadable_file'].message_type = _DOWNLOADABLEFILE
_CLAIM.fields_by_name['guncad_file'].message_type = _GUNCADFILE
