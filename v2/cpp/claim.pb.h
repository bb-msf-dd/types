...
enum Software_OS {
  ...
  Software_OS_IOS = 6,
  Software_OS_Software_OS_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Software_OS_Software_OS_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
...
class ClaimReference : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.ClaimReference) */ {
 public:
  ClaimReference();
  ...
  inline ClaimReference* New() const PROTOBUF_FINAL { return New(NULL); }

  ClaimReference* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class ClaimList : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.ClaimList) */ {
 public:
  ClaimList();
  virtual ~ClaimList();
  ...
  inline ClaimList* New() const PROTOBUF_FINAL { return New(NULL); }

  ClaimList* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class Guncad : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.Guncad) */ {
 public:
  ...
  void clear_guncad_category();
  static const int kGuncadCategoryFieldNumber = 4;
  const ::std::string& guncad_category(int index) const;
  ::std::string* mutable_guncad_category(int index);
  void set_guncad_category(int index, const ::std::string& value);
  void set_guncad_category(int index, const char* value);
  void set_guncad_category(int index, const char* value, size_t size);
  ::std::string* add_guncad_category();
  void add_guncad_category(const ::std::string& value);
  void add_guncad_category(const char* value);
  void add_guncad_category(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& guncad_category() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_guncad_category();

  // repeated string firearm_type = 5;
  int firearm_type_size() const;
  void clear_firearm_type();
  static const int kFirearmTypeFieldNumber = 5;
  const ::std::string& firearm_type(int index) const;
  ::std::string* mutable_firearm_type(int index);
  void set_firearm_type(int index, const ::std::string& value);
  void set_firearm_type(int index, const char* value);
  void set_firearm_type(int index, const char* value, size_t size);
  ::std::string* add_firearm_type();
  void add_firearm_type(const ::std::string& value);
  void add_firearm_type(const char* value);
  void add_firearm_type(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& firearm_type() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_firearm_type();

  // repeated string firearm_platform = 6;
  int firearm_platform_size() const;
  void clear_firearm_platform();
  static const int kFirearmPlatformFieldNumber = 6;
  const ::std::string& firearm_platform(int index) const;
  ::std::string* mutable_firearm_platform(int index);
  void set_firearm_platform(int index, const ::std::string& value);
  void set_firearm_platform(int index, const char* value);
  void set_firearm_platform(int index, const char* value, size_t size);
  ::std::string* add_firearm_platform();
  void add_firearm_platform(const ::std::string& value);
  void add_firearm_platform(const char* value);
  void add_firearm_platform(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& firearm_platform() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_firearm_platform();

  // repeated string firearm_part = 7;
  int firearm_part_size() const;
  void clear_firearm_part();
  static const int kFirearmPartFieldNumber = 7;
  const ::std::string& firearm_part(int index) const;
  ::std::string* mutable_firearm_part(int index);
  void set_firearm_part(int index, const ::std::string& value);
  void set_firearm_part(int index, const char* value);
  void set_firearm_part(int index, const char* value, size_t size);
  ::std::string* add_firearm_part();
  void add_firearm_part(const ::std::string& value);
  void add_firearm_part(const char* value);
  void add_firearm_part(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& firearm_part() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_firearm_part();

  // repeated string firearm_caliber = 8;
  int firearm_caliber_size() const;
  void clear_firearm_caliber();
  static const int kFirearmCaliberFieldNumber = 8;
  const ::std::string& firearm_caliber(int index) const;
  ::std::string* mutable_firearm_caliber(int index);
  void set_firearm_caliber(int index, const ::std::string& value);
  void set_firearm_caliber(int index, const char* value);
  void set_firearm_caliber(int index, const char* value, size_t size);
  ::std::string* add_firearm_caliber();
  void add_firearm_caliber(const ::std::string& value);
  void add_firearm_caliber(const char* value);
  void add_firearm_caliber(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& firearm_caliber() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_firearm_caliber();

  // repeated string fabrication_method = 9;
  int fabrication_method_size() const;
  void clear_fabrication_method();
  static const int kFabricationMethodFieldNumber = 9;
  const ::std::string& fabrication_method(int index) const;
  ::std::string* mutable_fabrication_method(int index);
  void set_fabrication_method(int index, const ::std::string& value);
  void set_fabrication_method(int index, const char* value);
  void set_fabrication_method(int index, const char* value, size_t size);
  ::std::string* add_fabrication_method();
  void add_fabrication_method(const ::std::string& value);
  void add_fabrication_method(const char* value);
  void add_fabrication_method(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& fabrication_method() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_fabrication_method();

  // repeated string fabrication_tools = 10;
  int fabrication_tools_size() const;
  void clear_fabrication_tools();
  static const int kFabricationToolsFieldNumber = 10;
  const ::std::string& fabrication_tools(int index) const;
  ::std::string* mutable_fabrication_tools(int index);
  void set_fabrication_tools(int index, const ::std::string& value);
  void set_fabrication_tools(int index, const char* value);
  void set_fabrication_tools(int index, const char* value, size_t size);
  ::std::string* add_fabrication_tools();
  void add_fabrication_tools(const ::std::string& value);
  void add_fabrication_tools(const char* value);
  void add_fabrication_tools(const char* value, size_t size);
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::std::string> firearm_part_;
...
class Software : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:pb.Software) */ {
 public:
  Software();
  virtual ~Software();
  ...
  inline Software* New() const PROTOBUF_FINAL { return New(NULL); }

  Software* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
inline void Claim::set_allocated_collection(::pb::ClaimList* collection) {
  clear_type();
  if (collection) {
    set_has_collection();
...
inline void Claim::set_allocated_repost(::pb::ClaimReference* repost) {
  clear_type();
  if (repost) {
    set_has_repost();
...
inline void Stream::set_allocated_image(::pb::Image* image) {
  clear_type();
  if (image) {
    set_has_image();
    type_.image_ = image;
...
inline void Stream::set_allocated_audio(::pb::Audio* audio) {
  clear_type();
  if (audio) {
    set_has_audio();
    type_.audio_ = audio;
...
inline void Stream::set_allocated_software(::pb::Software* software) {
  clear_type();
  if (software) {
    set_has_software();
...
template <> struct is_proto_enum< ::pb::ClaimList_ListType> : ::google::protobuf::internal::true_type {};
template <>
...
template <> struct is_proto_enum< ::pb::Software_OS> : ::google::protobuf::internal::true_type {};
template <>
